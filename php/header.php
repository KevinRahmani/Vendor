        ...
        <ul class="nav-links">
            <li>
                ...
                <ul class="sub-menu blank">
                    <li>
                        <a class="link_name" href="index.php">Accueil</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu">
                    <li><a class="link_name" href="categorie.php?categorie=high-tech">High-Tech</a></li>
                </ul>
            </li>
            <li>
                <div class="icon-link">
                ...
                <ul class="sub-menu">
                    <li><a class="link_name" href="categorie.php?categorie=bricolage, jardin et animalerie">Bricolage & co</a></li>
                </ul>
            </li>
            <li>
                <a href="categorie.php?categorie=musique, dvd et blu-ray">
                    <i class="fa-solid fa-compact-disc"></i>
                    <span class="link_name">Musiques, DVD et Blu-ray</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="categorie.php?categorie=musique, dvd et blu-ray">Musiques, DVD et Blu-ray</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="categorie.php?categorie=livre">Livre</a></li>
                </ul>
            </li>
            <li>
                <div class="icon-link">
                    <a href="categorie.php?categorie=cuisine et maison">
                        <i class="fa-solid fa-chair"></i>
                        <span class="link_name">Cuisine et Maison</span>
                    </a>
                </div>
                <ul class="sub-menu">
                    <li><a class="link_name" href="categorie.php?categorie=cuisine et maison">Cuisine et Maison</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="categorie.php?categorie=sports et loisirs">Sports et Loisirs</a></li>
                </ul>
            </li>
            <li>
                <a href="categorie.php?categorie=automobile">
                    <i class="fa-solid fa-car-side"></i>            
                    <span class="link_name">Automobile</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="categorie.php?categorie=automobile">Automobile</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu blank">
                    <li><a class="link_name" href="categorie.php?categorie=vetements">Vetements</a></li>
                </ul>
            </li>
            <li>
    ...
    <div class="container_ruban">
        <nav>
            ...
            <ol>
                ...
                <li><a href="produitsPopulaires.php">Best-sellers</a></li>
                ...
                <li><a href="
                    ...
                    if(isset($_SESSION['connecte'])){
                        switch ($_SESSION['connecte']) {
                            case 1:
                                echo "page_client.php";
                                break;
                            
                            case 2:
                                echo "page_vendeur.php";
                                break;
                            case 3:
                                echo "page_admin.php";
                                break;
                            case 4: 
                                echo "page_livreur.php";
                                break;
